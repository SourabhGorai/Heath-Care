...
#             "gender": self.doctor_data['gender'],  # Keep the original gender value, as it's not an entry
#             "contact_no": self.contact_no_entry.get(),
#             "email": self.email_entry.get(),
#             "address": self.address_entry.get(),
#             "medical_license_no": self.medical_license_no_entry.get(),
#             "specialization": self.specialization_entry.get(),
#             "qualification": self.qualification_entry.get(),
#             "available_days": self.available_days_entry.get(),
#             "timing": [timing.strip() for timing in self.timing_entry.get().split(',')]  # Split by comma
#         }
...
# if __name__ == "__main__":
#     root = ctk.CTk()
#     # username = "sourabh_gorai"  # Replace this with the actual username passed from the previous page
#     username = sys.argv[1]  # Replace this with the actual username passed from the previous page
#     app = DoctorProfileApp(root, username)
#     root.mainloop()
